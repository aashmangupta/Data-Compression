...
//checked and passed
BSTNODE *newBSTNODE(void *v, char character) {
...
//checked and passed
BSTNODE *insertBST(BST *t,void *value, char character) {
    if(t == 0) {
        return 0;
    }

    BSTNODE *currNode = newBSTNODE(value, character);
